...
public class RenderBlocksCTM extends RenderBlocks {
     ...
     *
     * ZERO is a special case, it is the absolute min point of the block. X, Y, Z, or any combination means that the
     * axes listed in the name are at 1. X, Y, Z, or any combination followed by HALF means that those axes are at 0.5.
    ...
    private int avg(int... lightVals) {
        ...
        return ((blockLightBitChannel / lightVals.length) & 0xFF) | ((redBitChannel / lightVals.length) & 0xF00)
