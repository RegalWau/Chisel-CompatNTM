...
public class RenderBlocksColumn extends RenderBlocks {
    ...
    public boolean renderStandardBlock(Block block, int x, int y, int z) {
        ...
        if (yp || yn) {
            ...
            if (yp && yn) sides[2] = submap.getSubIcon(0, 1);
            else if (yp) sides[2] = submap.getSubIcon(1, 1);
            else sides[2] = submap.getSubIcon(1, 0);
            ...
            if (xp || xn) {
                ...
                if (zp || zn) {
                    ...
                    if (zp && zn) sides[0] = submap.getSubIcon(0, 1);
                    else if (zp) sides[0] = submap.getSubIcon(1, 0);
                    else sides[0] = submap.getSubIcon(1, 1);
